    ...
    return Scaffold(
      ...
      body: WillPopScope(
        ...
        child: Column(
          children: [
            TitleBar(
                title: "JAsONIbSTebvXgAwKLqwuw==".aseUnlook() /* History */),
            Expanded(
                ...
                builder: (contex, setState) {
                        ...
                        children: [
                          FractionallySizedBox(
                            ...
                            child: AspectRatio(
                              aspectRatio: 1 / 1,
                              child:
                                  Image.asset("images/img_history_empty.png"),
                            ),
                          ),
                          Container(
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      } else if (ApplicationStatusUtils.isRefuse(
                              item.status!) ||
                      ...
                      } else if (ApplicationStatusUtils.isFinish(
                          item.status!)) {
                        img = "images/img_history_finish.png";
